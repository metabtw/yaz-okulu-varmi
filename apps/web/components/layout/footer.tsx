      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-slate-500 mb-6">
              Turkiye&apos;deki universitelerin yaz okulu derslerini tek platformda
              toplayan, ogrencilere akilli filtreleme ve karar destegi sunan
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/faq" className="text-sm hover:text-white transition-colors">Sikca Sorulan Sorular</Link></li>
              <li><Link href="/faq" className="text-sm hover:text-white transition-colors">Ogrenci Rehberi</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/register" className="text-sm hover:text-white transition-colors">Universite Kaydi</Link></li>
              <li><Link href="/universities-for" className="text-sm hover:text-white transition-colors">Entegrasyon Rehberi</Link></li>
              <li><Link href="/universities-for" className="text-sm hover:text-white transition-colors">Widget Dokumantasyonu</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/about" className="text-sm hover:text-white transition-colors">Hakkinda</Link></li>
            ...
            <div className="mt-6 p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
              <p className="text-xs font-semibold text-slate-300 mb-1">TUBITAK Destekli</p>
              <p className="text-xs text-slate-500 leading-relaxed">
                Bu proje TUBITAK akademik arastirma kapsaminda gelistirilmektedir.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="py-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} Yaz Okulu Var mi? - Tum haklari saklidir.
          </p>
